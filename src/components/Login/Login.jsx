  ...
  return (
    <>
      <section className="login grid grid-cols-1 lg:grid-cols-2">
        <div className="loginImg flex flex-col md:flex-row items-start text-3xl md:text-5xl space-y-3 md:space-y-0 md:space-x-3 hidden md:block" style={{ backgroundImage: 'url("/assets/Robot blur.png")'}}>
